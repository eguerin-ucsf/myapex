...
<div id="header" class="clearfix">
  ...
  <?php if ($main_menu || $search_box): ?>
    <div id="menu-and-search-mobile">
      <?php if ($main_menu): ?>
        <div id="menu-mobile-controller"><div id="menu-mobile-controller-inner"><?php print l('UCSF', ''); ?> <span class="menu-link"><?=t('Menu');?></span></div></div>
      <?php endif; ?>
      <?php if ($search_box): ?>
  ...
  <?php if (isset($subsite) && $subsite): ?>
    <h1 id="subsite-title"><?php print $subsite_parent_title?></h1>
  <?php endif ?>
